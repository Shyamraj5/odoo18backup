...
class CompanyBalanceWizard(models.TransientModel):
    _name = 'cash.summary.wizard'
    _description = 'Cash Summary Wizard'
    ...
    def print_report(self):
        ...
        return self.env.ref('code_ox_cash_summary_report.action_cash_summary_report').report_action(self, data=data)