...
class ReportCompanyBalance(models.AbstractModel):
    _name = 'report.code_ox_cash_summary_report.cash_summary_report'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        wizard = self.env['cash.summary.wizard'].browse(docids[0]) if docids else False

        return {
            'doc_ids': docids,
            'doc_model': 'cash.summary.wizard',
            'docs': wizard,
            'data': data,
            'balances': balances,
            'date_from': date_from,
